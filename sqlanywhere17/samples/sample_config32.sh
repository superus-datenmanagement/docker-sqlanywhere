...
echo "Setting up sample_env script... "
    ...
    echo "# Set up the SQLANYSAMP17 env var for samples that may need"		    >> "$SAMPLES_DESTDIR/sample_env32.sh"
    echo "SQLANYSAMP17=\"$SAMPLES_DESTDIR\""		>> "$SAMPLES_DESTDIR/sample_env32.sh"
    echo "export SQLANYSAMP17"		    >> "$SAMPLES_DESTDIR/sample_env32.sh"
