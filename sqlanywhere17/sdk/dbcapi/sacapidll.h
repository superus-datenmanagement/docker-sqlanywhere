...
typedef void (*sqlany_clear_error_func)( a_sqlany_connection * sqlany_conn );
    ...
    typedef sacapi_bool (*sqlany_set_connect_property_func)( a_sqlany_connection * sqlany_conn, const char * property, const char * value );
    typedef sacapi_bool (*sqlany_connect2_func)( a_sqlany_connection * sqlany_conn );
    typedef sacapi_bool (*sqlany_set_autocommit_func)( a_sqlany_connection * sqlany_conn, sacapi_bool mode );
    typedef sacapi_bool (*sqlany_get_autocommit_func)( a_sqlany_connection * sqlany_conn, sacapi_bool * mode );
    typedef sacapi_bool (*sqlany_set_transaction_isolation_func)( a_sqlany_connection * sqlany_conn, sacapi_u32 isolation_level );
    typedef sacapi_bool (*sqlany_set_query_timeout_func)( a_sqlany_stmt * sqlany_stmt, sacapi_i32 query_timeout );
    typedef sacapi_i32  (*sqlany_get_function_code_func)( a_sqlany_stmt * sqlany_stmt );
    typedef sacapi_i32  (*sqlany_get_param_data_func)( a_sqlany_stmt * dbcapi_stmt, sacapi_u32 col_index, size_t offset, void * buffer, size_t size );
    typedef sacapi_bool (*sqlany_register_warning_callback_func)( a_sqlany_connection * sqlany_conn, SQLANY_CALLBACK_PARM callback, void * user_data );
    typedef sacapi_bool (*sqlany_register_message_callback_func)( a_sqlany_connection * sqlany_conn, SQLANY_CALLBACK_PARM callback, void * user_data );
#endif
...
#if _SACAPI_VERSION+0 >= SQLANY_API_VERSION_6
    /** Pointer to ::sqlany_set_connect_property() function.
    */
    function( sqlany_set_connect_property );

    /** Pointer to ::sqlany_connect2() function.
     */
    function( sqlany_connect2 );

    /** Pointer to ::sqlany_set_autocommit() function.
     */
    function( sqlany_set_autocommit );

    /** Pointer to ::sqlany_get_autocommit() function.
     */
    function( sqlany_get_autocommit );

    /** Pointer to ::sqlany_set_transaction_isolation() function.
     */
    function( sqlany_set_transaction_isolation );

    /** Pointer to ::sqlany_query_timeout() function.
     */
    function( sqlany_set_query_timeout );

    /** Pointer to ::dbcapi_get_function_code() function.
     */
    function( sqlany_get_function_code );

    /** Pointer to ::sqlany_get_param_data() function.
     */
    function( sqlany_get_param_data );

    /** Pointer to ::sqlany_register_warning_callback() function.
     */
    function( sqlany_register_warning_callback );

    /** Pointer to ::sqlany_register_message_callback() function.
     */
    function( sqlany_register_message_callback );
#endif
